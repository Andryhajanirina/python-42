...
In this exercise, we learn that in the digital realm, programs need to receive instructions from the outside world.  
Our mission is to discover how programs can receive messages from their users!  
And, in this section we learn about **LIST**, **sys.argv**

## Exercise 1: Score Cruncher (use of LIST and try/except)
In this exercise, we will get game scores as command-line parameters, and we need to :
...
* Calculate some basic stats that would make any game player happy (number, total,
average, max, min, and range)
* Make the output look cool enough to impress your gaming buddies
* If both valid and invalid inputs are provided via the command line, discard the
invalid ones and proceed with the remaining valid inputs unless none remain
